...
class TradingApplication:
    ...
    def __init__(self) -> None:
        ...
        self.news_provider = (
            JsonNewsEventProvider(NEWS_CALENDAR_FILE)
    ...
    def _process_symbol(self, symbol, data, higher_tf) -> float:
        ...
        signal = self.strategy_router.generate_analysis(
        ...
        requested_risk = (
            equity
            * (RISK_PERCENT / 100.0)
            * float(signal.get("risk_multiplier", 1.0))
        )
    ...
    def run_cycle(self) -> None:
        ...
        management = self.execution.manage_positions(
        ...
        self.equity_history.append(
            EquityPoint(timestamp=now, equity=account.equity)
        )
